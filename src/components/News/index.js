  ...
  <div className="block news">
    ...
    <div className="news__item">
      <h3 className="news__item-name">
        В театре раскольников премьера!
      </h3>
      <div className="news__item-text">
        <p>
          Новый спектакль называется <Link to="/play/car">"Не садись в машину, где двое"</Link><br />
          Премьера состоится <strong>23 сентября</strong>, не пропустите!<br />
          Приобрести билеты вы можете на месте, стоимость: <strong>100 грн</strong>.
        </p>
      </div>
    </div>
    {/*<div className="news__item">*/}
