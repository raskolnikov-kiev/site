      ...
      <div>
        <div className="news__item">
          ...
          <div className="news__item-text">
            ...
            <p>
            <b>22 ноября</b> стартует <Link to="/platform">уникальный воркшоп «Актёрская платформа»</Link>!<br />Впервые в Украине!<br />

            Интенсив, длинною 3 дней откроет вам мир <b>биомеханики Всеволода Мейерхольда, мир архетипов и Психологических жестов Михаила Чехова</b>. <br />
